...
app_name = 'stocks'  # Needed for namespacing with templates - 'stocks:summary'
urlpatterns = [
...
#    url(r'^(?P<stock_id>[0-9]+)/$', views.summary, name='summary'),
    ...
    url(r'^indexes/(?P<index_id>[0-9]+)/$', views.index_history, name='index_history'),
    # url(r'^indexes/(?P<pk>[0-9]+)/$', views.IndexHistoryView.as_view(), name='index_history'),
